...
module Jira4R
  ...
  class JiraTool
    ...
    def getProjectNoScheme(key)
      @logger.debug("getProjectNoScheme is deprecated. Please call getProjectNoSchemes.")
    ...
    def getProject(key)
      ...
      @logger.debug("Using deprecated JIRA4R API call getProject(key); replace with getProjectByKey(key)")
